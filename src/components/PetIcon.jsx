    ...
    return (
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" 
                viewBox="0 0 600 600" 
                className={`w-14 h-14 z-10 absolute text-[#7F9FB5] ${position} transform -translate-y-1/2 transition-transform duration-300 ease-in-out`}
...
const PetIcon = ({ name, image, isSelected, onClick }) => {
    ...
    return (
        <div onClick={onClick} className="w-40 h-40 flex flex-col items-center group relative cursor-pointer">
            {isSelected && <Triangle position="left-[150px] top-12"/>}
