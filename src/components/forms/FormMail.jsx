...
const FormMail = ({ label, placeholder }) => {
    return (
        <div className="p-2 flex-col justify-start items-start gap-0.5">
            ...
            <input type="email" className="w-full self-stretch h-12 p-3 bg-neutral-50 rounded justify-start items-start gap-2.5 flex-1" placeholder={placeholder} />
        </div>
    );
};
